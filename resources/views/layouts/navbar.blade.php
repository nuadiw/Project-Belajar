        ...
        <ul class="navbar-nav navbar-nav-right pe-4">
            ...
            <li class="nav-item nav-profile dropdown ms-2">
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown" style="position: absolute; top: 100%; left: auto; right: 0; margin-top: 8px; z-index: 1050;">
                    {{-- Gunakan /dashboard atau route('dashboard') --}}
                    <li><a class="dropdown-item" href="{{ url('/dashboard') }}"><i class="mdi mdi-view-dashboard me-2"></i>Dashboard</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="mdi mdi-account me-2"></i>Profile</a></li>
                    <li>
                        {{-- PERBAIKAN: Gunakan route('logout') agar mengarah ke POST /logout yang benar --}}
            ...
            @else
            <form class="d-flex">
                {{-- Gunakan /login agar tidak menjadi kegiatan/login --}}
                <a href="{{ url('/login') }}" class="btn btn-success">
                    <i class="mdi mdi-login me-2 {{ ($title === 'Login') ? 'active' : '' }}"></i> Login
                </a>
            </form>
            @endauth
        </ul>
